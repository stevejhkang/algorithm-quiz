 ...
 * @time 2020. 2. 25. 오후 10:43:40
 * @category 
* @problem_description 어떤 지역의 높이 정보가 주어졌을때, 장마철에 물에 잠기지 않는
* 안전한 영역의 최대 개수를 계산하라
* @solving_description 물레벨은 하나씩 높이면서 이중포문을  물레벨보다 높은 곳이 나타나면
* 그 곳을 시작점으로 같은 섬이 되는 것을 BFS로 방문하여 처리해주고
* 나머지 이중포문을 계속돌면서 섬의개수를 체크해줘서 최종적으로 섬이 몇개인지를 계산하고
* 그게 현재까지 구한 섬의 최대개수와 비교하면서 갱신한다.
*/

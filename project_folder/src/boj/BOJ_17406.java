...
/**
 * @author junhukang
 * @time 2020. 2. 6. 오전 3:28:04
 * @category 완전탐색, 시뮬레이션
 * @problem_description
 * @solving_description 배열을 돌리는 인덱스 설정이 중요했음, 
 * 그리고 순서를 위한 순열짜는 문제
 * -> 순열 짤때 넣을 때 몇개인지 모르면 ArrayList에 넣고 몇 개인지 알면 배열에 넣으면 된다.
 */
